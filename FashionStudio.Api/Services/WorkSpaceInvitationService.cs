    ...
    public class WorkSpaceInvitationService : IWorkSpaceInvitation
    {
            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    throw new Exception("Only the workspace owner can send invitations.");
                }
                ...
                {
                    throw new Exception("User already added as a member");
                }
                ...
                {
                    throw new Exception("An invitation has already been sent to this email for the specified workspace.");
                }
            ...
            {
                throw new Exception($"Error sending invitation: {ex.Message}");
            }
        ...
        public async Task<AcceptInvitationDTO> RespondToInvitationAsync(string invitationCode, InvitationStatus accept, CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (invitation == null)
                {
                    throw new Exception("Invitation not found or has expired.");
                }
            ...
            {
                throw new Exception($"Error responding to invitation: {ex.Message}");
            }
        }
